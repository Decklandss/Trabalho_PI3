import 'package:libras/src/feature/auth/data/repository/signup_screen_repository.dart';
...
class SignupUseCase {
  ...
  Future<SignupUser> signup(String username, /*String name,*/ String email,
      String password, String confirmPassword) {
    ...
    if (!respValidateAllFields[0]) {
      ...
      return repository.signup(
          SignupUser(username, /*name ,*/ email, password, confirmPassword));
    }
  }
}
